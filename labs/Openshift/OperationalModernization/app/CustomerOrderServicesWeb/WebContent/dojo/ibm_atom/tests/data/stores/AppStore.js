dojo.provide("ibm_atom.tests.data.stores.AppStore");
dojo.require("ibm_atom.data.AppStore");
dojo.require("dojo.data.api.Read");
dojo.require("dojo.data.api.Write");


ibm_atom.tests.data.stores.AppStore.getStore = function(){
	return new ibm_atom.data.AppStore({url: "../../ibm_atom/tests/widget/samplefeedEdit.xml"});
};
ibm_atom.tests.data.stores.AppStore.getStore2 = function(){
	return new ibm_atom.data.AppStore({url: "../../ibm_atom/tests/widget/samplefeedEdit.xml"});
};

doh.register("ibm_atom.tests.data.stores.AppStore", 
	[
		function testReadAPI_fetch_all(t){
			...
			//	description:
			//		Simple test of fetching all xml items through an XML element called isbn
			var store = ibm_atom.tests.data.stores.AppStore.getStore();
		...
		function testReadAPI_isItem_multistore(t){
			...
			//	description:
			//		Simple test of the isItem API across multiple store instances.
			var store1 = ibm_atom.tests.data.stores.AppStore.getStore();
			var store2 = ibm_atom.tests.data.stores.AppStore.getStore2();
		...
		function testReadAPI_functionConformance(t){
			...
			var testStore = ibm_atom.tests.data.stores.AppStore.getStore();
